...
/*
    ...
    private static void addServiceCall() {
        ...
        System.out.println("3. Add service call for water heater");     //added water heater to 3
        System.out.println("4. Quit");                              //changed quit to 4
        ...
        switch (choice) {
            ...
            //takes same input then AC and adds the int input for age
            case 3: {
